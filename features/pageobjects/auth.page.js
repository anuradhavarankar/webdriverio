class AuthPage {
  ...
  createAccount = async(emailId,address)=>{
          ...
          await this.txt_AdditionalInfo.setValue("This is my additional information");
          await this.input_Phone.setValue("12334566");
          await this.input_MobilePhone.setValue("+65 94657845");
          await this.input_AddressAlias.setValue("Address");
          await this.btn_Submit.click();
 
  };

  //SignIn using newly created credentails
